...
#import "WaterCannonsViewController.h"
...
@interface WaterCannonsViewController ()<UITableViewDataSource,UITableViewDelegate>
{
...
@implementation WaterCannonsViewController
{
...
-(void)getHistory{
    ...
    [params setObject:@"4" forKey:@"lerun_theme"];
