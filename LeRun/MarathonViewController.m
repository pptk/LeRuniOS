...
#import "MarathonViewController.h"
...
@interface MarathonViewController ()<UITableViewDataSource,UITableViewDelegate>
{
...
@implementation MarathonViewController
{
...
-(void)getHistory{
    ...
    [params setObject:@"3" forKey:@"lerun_theme"];
