...
@interface PapaWViewController ()<UITableViewDataSource,UITableViewDelegate>
{
...
@implementation PapaWViewController
{
...
-(void)createTheme{
    ...
    NSString *htmlPath = [[NSBundle mainBundle] pathForResource:@"popRuns" ofType:@"html"];
...
-(void)getHistory{
    ...
    [params setObject:@"1" forKey:@"lerun_theme"];
