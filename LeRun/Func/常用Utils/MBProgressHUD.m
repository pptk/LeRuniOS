...
- (void)layoutSubviews {
    ...
    if (nil != self.labelText) {
        ...
        CGSize dims = [FuncPublic checkSizeFromString:self.labelText Font:self.labelFont Width:MAXFLOAT Height:MAXFLOAT];
        ...
        if (nil != self.detailsLabelText) {
            ...
            CGSize labelSize = [FuncPublic checkSizeFromString:detailsLabel.text Font:detailsLabel.font Width:frame.size.width - 4 * margin Height:maxHeight];
